...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 04-Maio-2020 às 00:50
...
CREATE TABLE IF NOT EXISTS `sm_newsletter` (
  ...
  `newsletter_registration` datetime DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`newsletter_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Essa tabela recebe os e-mail para boletim de noticias';

-- --------------------------------------------------------

--
-- Estrutura da tabela `sm_siteviews`
--

DROP TABLE IF EXISTS `sm_siteviews`;
CREATE TABLE IF NOT EXISTS `sm_siteviews` (
...
--
-- Estrutura da tabela `sm_siteviews_agent`
--

DROP TABLE IF EXISTS `sm_siteviews_agent`;
CREATE TABLE IF NOT EXISTS `sm_siteviews_agent` (
...
--
-- Estrutura da tabela `sm_siteviews_online`
--

DROP TABLE IF EXISTS `sm_siteviews_online`;
CREATE TABLE IF NOT EXISTS `sm_siteviews_online` (
