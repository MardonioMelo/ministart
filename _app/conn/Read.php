...
class Read extends Conn
{
    ...
    /**
     * <b>Exe Full Read:</b> Executa uma leitura personalizada. Basta informar a query,
     * os termos da seleção e uma analize em cadeia (ParseString) para executar.
     * @param STRING $Query = Query personalizada
     * @param STRING $ParseString = WHERE | ORDER | LIMIT :limit | OFFSET :offset | link={$link}&link2={$link2}
     */
    ...
    private function Execute()
    {
        ...
        try {
            ...
            $this->Result = null;
            SMErro("<b>Erro ao Ler:</b> {$e->getMessage()}", $e->getCode());
        }
    }
